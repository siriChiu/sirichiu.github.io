...
*   **智慧校正機制 (Smart Calibration)**：設計了一套自動化參數調適流程。
    ...
    *   *成效*：簡化因材質、硬體與環境差異所需的驗證程序，提升客戶產線調校效率與使用者體驗一致性。

#### 2. 演算法與韌體工程 (Algorithm & Firmware Engineering)
*   **訊號處理**：運用 **MATLAB** 進行超音波訊號分析。實作雜訊濾除（涵蓋線性與非線性濾波）以及觸碰演算法開發，改善手勢識別穩定性。
*   **韌體實作**：使用 **C++** 進行韌體編寫。將模擬驗證後的效能參數與新功能（如虛擬按鍵觸發機制）移植至韌體中，支援智慧型手機（如 ROG Phone）與筆電觸控板等產品導入。
...
![超音波觸控模組測試畫面](/postImg/job_sentos/1.jpg)

**Image 2: 訊號處理流程圖**

![韌體與觸控校正測試畫面](/postImg/job_sentos/2.jpg)
