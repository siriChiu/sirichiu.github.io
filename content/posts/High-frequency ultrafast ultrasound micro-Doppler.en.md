...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/0.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/1.png)

## Flow Diagram

![High-frequency ultrasound processing result](/postImg/HFUDCEI/2.png)

## Clutter Filter - (Block-wise SVD)

Singular Value Decomposition is a commonly used mathematical tool for feature extraction. Here I perform SVD decomposition on the entire ultrasound sequence data to obtain three matrices U, Δ, V. U is the left singular vector matrix representing spatial information in ultrasound, V represents temporal information, and Δ represents the weight distribution in the data.

![High-frequency ultrasound processing result](/postImg/HFUDCEI/3.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/4.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/5.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/6.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/7.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/8.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/9.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/10.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/11.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/12.png)
...
![High-frequency ultrasound processing result](/postImg/HFUDCEI/13.png)
